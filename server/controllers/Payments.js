...
exports.capturePayment = async (req, res) => {
    ...
    for (const course_id of courses) {
        ...
        try {
            ...
            const uid = new mongoose.Types.ObjectId(userId)//beacuse user id is stored as object id in course schema in DB
    ...
    try {
        // Initiate the payment using Razorpay(create order)
...
//         await enrollStudents(courses, userId, res)//neeche hai ye function
...
exports.verifyPayment = async (req, res) => {
    ...
    if (expectedSignature === razorpay_signature) {
        try {
            // Await enrollment but don't pass 'res' to it
